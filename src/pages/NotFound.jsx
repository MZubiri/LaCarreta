...
export const NotFound = () => {
  return (
    <div className="not-found-page container text-center" style={{ padding: '5rem 1rem' }}>
      <span style={{ fontSize: '5rem', display: 'block', marginBottom: '1rem' }}>🌺</span>
      <h1 style={{ fontSize: '4rem', marginBottom: '0.5rem', color: 'var(--color-accent, #AF1723)' }}>404</h1>
